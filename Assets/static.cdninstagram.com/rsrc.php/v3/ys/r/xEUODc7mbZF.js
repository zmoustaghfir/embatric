...
__d("LoginFormRedirect", [], (function(a, b, c, d, e, f) {
    "use strict";
    var g = /c_user=(.+?)(;|$)/;

    function a(a) {
        var b = window.setInterval(function() {
            g.test(document.cookie) && (window.clearInterval(b), window.location.href = a)
        }, 5e3);
...
__d("hashString", [], (function(a, b, c, d, e, f) {
    "use strict";
...
__d("QPLCore", ["QPLEvent", "QPLTimestamp", "QPLUtils", "QuickPerformanceLoggerTypes", "uuidv4"], (function(a, b, c, d, e, f, g) {
    ...
    a = function() {
        ...
        b.markerStart = function(a, b, c, e) {
            ...
            g = g === void 0 ? !1 : g;
            var i = e.trackedForLoss;
            i = i === void 0 ? !1 : i;
            var j = e.type;
            j = j === void 0 ? 1 : j;
            var k = e.samplingBasis;
            k = k === void 0 ? null : k;
            var l = e.qplInternalDoNotUseAbsoluteTimeOrigin;
            e = e.timeoutMS;
            e = e === void 0 ? null : e;
            var m = this.getMarker(a, b);
            if (m) {
                m = Math.round(c - m.timestamp);
                f && (this.markerAnnotate(a, {
                    string: {
                        cancel_type: "DUPLICATE_EVENT"
                    },
                    "int": {
                        time_between_markers_ms: m
                    }
                }, {
                    instanceKey: b
            ...
            typeof l === "number" && (n.absoluteTimeOrigin = l);
            this.$4.forEach(function(d) {
                d.onMarkerStart && d.onMarkerStart(a, b, c)
            });
            this.$5.forEach(function(d) {
                d.onMarkerStartWithMarker(a, b, c, n)
            });
            m && (this.addMarker((h || (h = d("QPLEvent"))).getMarkerId(a), b, n), e != null && this.$12(a, b, e));
            m && i === !0 && this.$13({
                marker_id: 27787271,
                action_id: 0,
                sample_rate: 1,
                annotations_int: {
                    tracked_marker_id: (h || (h = d("QPLEvent"))).getMarkerId(a)
                },
                marker_type: 1
            });
            m && this.$4.forEach(function(d) {
...
__d("QuickPerformanceLogger", ["Arbiter", "Env", "FBLogger", "PerfFalcoEvent", "PerfXSharedFields", "Promise", "QPLCore", "QPLEvent", "QPLInspector", "Run", "USID", "WebStorage", "cr:1984081", "cr:686", "gkx", "performanceAbsoluteNow", "performanceNavigationStart", "performanceNow"], (function(a, b, c, d, e, f, g) {
    ...
    function o(a) {
        ...
        if (c("gkx")("3752") && typeof n.__sapienzMetadataCallback__ === "function") {
    ...
    function s() {
        return (i || (i = c("Env"))).enable_qplinspector === !0 || typeof n.__je2e_recordQPLMarker === "function" || c("gkx")("1738486")
    }
...
__d("QPLE2E", ["QuickPerformanceLogger"], (function(a, b, c, d, e, f, g) {
    ...
    a = function() {
        ...
        b.logPoint = function(a, b, d, e) {
            var f, g;
            e === void 0 && (e = {});
            f = (f = e.timestamp) != null ? f : (h || (h = c("QuickPerformanceLogger"))).currentTimestamp();
            var i = babelHelpers["extends"]({}, e.pointData);
            g = (g = e.action) != null ? g : 12524;
            e.secondaryOrder != void 0 && (i.string || (i.string = {}), i.string.qpl_e2e__secondary_order = e.secondaryOrder);
            if (e.sessionMarker && e.sessionMarker !== "none") {
                var j;
                i.bool || (i.bool = {});
                i.bool = babelHelpers["extends"]({}, i.bool, (j = {}, j.qpl_e2e__session_marker_start_point = e.sessionMarker === "start", j.qpl_e2e__session_marker_end_point = e.sessionMarker === "end", j))
            ...
            e.annotations && (h || (h = c("QuickPerformanceLogger"))).markerAnnotate(a, e.annotations);
            h.markerAnnotate(a, {
                string: (j = {}, j.join_id = d, j.qpl_join__source = "client", j),
...
__d("PlatformOAuthDialogLoginFunnelLogger", ["FBLogger", "QPLE2E", "URI", "qpl"], (function(a, b, c, d, e, f, g) {
    ...
    var j = function() {
        ...
        l = function() {
            return (h || (h = c("URI"))).getRequestURI().setQueryString("").toString()
        },
        m = function() {
...
__d("XOauthDialogController", ["XController"], (function(a, b, c, d, e, f) {
...
__d("PlatformDialogCBTSetter", ["PlatformOAuthDialogLoginFunnelLogger", "URI", "XOauthDialogController", "uuidv4"], (function(a, b, c, d, e, f, g) {
    "use strict";
    var h;
    ...
    function b(a, b, e) {
        ...
        if (!g) return;
        g = new h(g);
        var i = c("XOauthDialogController").getURIBuilder().getURI().getPath().toString();
        i.endsWith("/") && (i = i.substr(0, i.length - 1));
        if (!g.getPath().includes(i)) return;
        i = g.getQueryData().cbt;
        var j = g.getQueryData().logger_id;
        i || (i = Date.now(), g.addQueryData("cbt", i), f.addQueryData("next", g.toString()), a.action = f.toString());
        j || (j = c("uuidv4")(), g.addQueryData("logger_id", j), f.addQueryData("next", g.toString()), a.action = f.toString());
