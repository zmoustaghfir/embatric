...
__d("CometKeyCommandSettingsContext", ["CometCustomKeyCommands", "gkx", "react"], (function(a, b, c, d, e, f, g) {
    ...
    var h;
    a = h || d("react");
    var i = c("CometCustomKeyCommands").areSingleKeysDisabled === null && !c("gkx")("1707273") ? !1 : c("CometCustomKeyCommands").areSingleKeysDisabled;
    b = a.createContext({
...
__d("stylex-runtime", ["styleq", "stylex-inject"], (function(a, b, c, d, e, f, g) {
    ...
    var j = {
            angle: function(a) {
                throw new Error(k("angle"))
            },
            color: function(a) {
                throw new Error(k("color"))
            },
            url: function(a) {
                throw new Error(k("url"))
            },
            image: function(a) {
                throw new Error(k("image"))
            },
            integer: function(a) {
                throw new Error(k("integer"))
            },
            lengthPercentage: function(a) {
                throw new Error(k("lengthPercentage"))
            },
            length: function(a) {
                throw new Error(k("length"))
            },
            percentage: function(a) {
                throw new Error(k("percentage"))
            },
            number: function(a) {
                throw new Error(k("number"))
            },
            resolution: function(a) {
                throw new Error(k("resolution"))
            },
            time: function(a) {
                throw new Error(k("time"))
            },
            transformFunction: function(a) {
                throw new Error(k("transformFunction"))
            },
            transformList: function(a) {
                throw new Error(k("transformList"))
            }
        },
        k = function(a) {
    ...
    o.spread = a;
    o.create = b;
    o.unstable_createVars = e;
    o.unstable_overrideVars = f;
    o.include = i;
    o.keyframes = l;
    o.firstThatWorks = m;
    o.inject = c("stylex-inject");
    o.UNSUPPORTED_PROPERTY = n;
    o.types = j;
    o = o;
    g.spread = a;
    g.create = b;
    ...
    g.UNSUPPORTED_PROPERTY = n;
    g.stylex = o
}), 98);
__d("stylex", ["CometStyleXSheet", "ExecutionEnvironment", "gkx", "stylex-runtime"], (function(a, b, c, d, e, f, g) {
    "use strict";
    var h, i;
    !c("gkx")("1705") && !(i || (i = c("ExecutionEnvironment"))).isInWorker && d("CometStyleXSheet").rootStyleSheet.injectTheme();
    var j = !1;
    ...
    e = function(a, b, e) {
        e === void 0 && (e = null), !j && c("gkx")("708253") && a.indexOf("@keyframes") === -1 && (j = !0), d("CometStyleXSheet").rootStyleSheet.insert(a, b, e)
    };
    ...
    b.spread = h.stylex.spread;
    b.unstable_createVars = h.stylex.unstable_createVars;
    b.unstable_overrideVars = h.stylex.unstable_overrideVars;
    f = b;
    g["default"] = f
}), 102);
__d("createKeyCommandWrapper", ["CometKeyCommandContext", "CometKeyCommandSettingsContext", "CometKeyCommandUtilsContext", "CometKeyCommandsTypedLoggerLite", "areKeyCombinationsEqual", "createKeyCommand", "gkx", "isSingleCharKey", "react", "recoverableViolation", "stylex", "useStable"], (function(a, b, c, d, e, f, g) {
    ...
    function s(a, b) {
        return c("gkx")("3598") && b.triggerFromInputs === !0 && p(a) && ((a = b.command) == null ? void 0 : a.alt) === !0
    }
    var t = function(a, b) {
...
__d("BaseKeyCommandListener.react", ["CometGlobalKeyCommandWidget", "CometKeyCommandUtilsContext", "ReactDOMComet", "applyKeyCommand", "getActiveCommands", "getKeyCommand", "react", "recoverableViolation", "stylex", "useGetComposingState", "useGlobalEventListener", "useUnsafeRef_DEPRECATED"], (function(a, b, c, d, e, f, g) {
    ...
    function a(a) {
        var b = o(null),
            e = o(null),
            f = o(new Set()),
            g = m(c("CometGlobalKeyCommandWidget").Context),
            j = l(function(d) {
        ...
        j = (h || (h = c("useUnsafeRef_DEPRECATED")))({
            addObserver: j,
            notifyCommandUpdate: s,
            setActiveLayer: t,
            setActiveWrapper: u
        });
        t = l(function() {
        ...
        c("useGlobalEventListener")("keydown", u);
        c("useGlobalEventListener")("keyup", u);
        return k.jsx(c("CometKeyCommandUtilsContext").Provider, {
            value: j.current,
            children: k.jsx("div", {
                className: (i || (i = c("stylex")))(a.xstyle),
                onBlurCapture: t,
                children: a.children
            })
        })
...
__d("OutsideExceptionKeyCommandListener.react", ["BaseKeyCommandListener.react", "CometLayerKeyCommandWrapper.react", "react"], (function(a, b, c, d, e, f, g) {
    ...
    function a(a) {
        return i.jsx(c("BaseKeyCommandListener.react"), {
            observersEnabled: !1,
...
__d("LegacyHidden", ["react"], (function(a, b, c, d, e, f, g) {
    ...
    function b(a, b) {
        ...
        return i.jsx(k, {
            mode: e,
            children: i.jsx("div", babelHelpers["extends"]({}, d, {
                ref: b,
                suppressHydrationWarning: a,
                children: c
            }))
...
__d("WebView.react", ["LegacyHidden", "react", "stylex", "testID"], (function(a, b, c, d, e, f, g) {
    "use strict";
    var h, i, j = i || d("react"),
        k = {
            hidden: {
    ...
    function a(a, b) {
        ...
        return j.jsx(c("LegacyHidden"), {
            htmlAttributes: babelHelpers["extends"]({}, a, c("testID")(f), {
                className: (h || (h = c("stylex")))(k.root, g, i && k.hidden)
            }),
            mode: i ? "hidden" : "visible",
            ref: b,
...
__d("BaseView.react", ["WebView.react"], (function(a, b, c, d, e, f, g) {
    "use strict";
    g["default"] = c("WebView.react")
}), 98);
...
__d("VisibilityState", ["VisibilityAPI", "performanceNowSinceAppStart"], (function(a, b, c, d, e, f, g) {
    ...
    d("VisibilityAPI").canUseVisibilityAPI && d("VisibilityAPI").onVisibilityChange(function(a) {
        m(a, d("VisibilityAPI").isVisibilityHidden()), l.forEach(function(b) {
...
__d("LongtaskObserver", [], (function(a, b, c, d, e, f) {
    "use strict";
    var g = typeof((c = window.PerformanceObserver) == null ? void 0 : (d = c.supportedEntryTypes) == null ? void 0 : d.includes) === "function" && window.PerformanceObserver.supportedEntryTypes.includes("longtask"),
        h = new Set(),
        i = !1;
...
__d("ResponsivenessTracker", ["LongtaskObserver", "OneTraceCore", "VisibilityState", "WebAPIs", "addAnnotations", "performanceNowSinceAppStart", "uuidv4"], (function(a, b, c, d, e, f, g) {
    "use strict";
    var h = 100,
        i = 3,
        j = ["click", "keyup"],
        k = !1,
        l = 1,
        m = typeof((b = window.PerformanceObserver) == null ? void 0 : (e = b.supportedEntryTypes) == null ? void 0 : e.includes) === "function" && window.PerformanceObserver.supportedEntryTypes.includes("event");
    ...
    function p(a, b) {
        if (o) {
            ...
            d.navigationMetrics.endTime != null && (d.metrics.markerPoints.navigationEnd = {
                timeSinceStart: d.navigationMetrics.endTime
            });
            for (var f in d.longtaskStat) {
                var g, h = d.longtaskStat[f];
                c("addAnnotations")(e, {
                    "int": (g = {}, g[f + "Count"] = h.count, g[f + "Total"] = h.total, g[f + "Max"] = h.max, g[f + "Avg"] = h.count > 0 ? h.total / h.count : 0, g)
                })
            }
            c("addAnnotations")(e, {
                "int": {
    ...
    function s(a, b) {
        if (r) {
            var d = r;
            d && (o = {
                metrics: c("OneTraceCore").startTrace(c("uuidv4")(), a, "RESPONSIVENESS", b),
                navigationMetrics: d,
                longtaskStat: {
                    inputDelay: {
                        count: 0,
    ...
    function a(a) {
        if (!k) {
            ...
            d("LongtaskObserver").subscribe(function(b) {
                ...
                d = c("OneTraceCore").startTrace(c("uuidv4")(), (d = c("OneTraceCore").getLastNavigation()) == null ? void 0 : d.tracePolicy, "LONGTASK", b.startTime);
                ...
                n(d);
                c("OneTraceCore").endTrace(d.traceID, b.startTime + b.duration, "SUCCESS")
            });
            if (m) {
                var g = new Set((b = a.Responsiveness.overrideDelayedEventTypeFilter) != null ? b : j);
                b = new window.PerformanceObserver(function(b) {
                    b.getEntries().forEach(function(b) {
                        ...
                        if (h >= e) {
                            h = c("OneTraceCore").startTrace(c("uuidv4")(), (h = c("OneTraceCore").getLastNavigation()) == null ? void 0 : h.tracePolicy, "INPUT_DELAY", b.startTime);
                            var i = b.processingStart - b.startTime;
                            c("addAnnotations")(h.annotations, {
                                "int": {
                                    hidden: Number(d("VisibilityState").wasHidden(b.startTime, b.processingStart))
                                },
                                string: {
                            ...
                            n(h);
                            if (a.Responsiveness.getReactComponentStackFromDOMElement != null && b.target != null) {
                            ...
                            c("OneTraceCore").endTrace(h.traceID, b.processingStart, "SUCCESS");
                            q("inputDelay", b.startTime, i, f);
                            o != null && (i >= 200 && (o.ST200 += i, i >= 500 && (o.ST500 += i, i >= 1e3 && (o.ST1000 += i))))
                        }
                    })
                });
                b.observe({
            ...
            c("OneTraceCore").currentTraces.forEach(function(a) {
                a.traceType === "INITIAL_LOAD" && (r = a, s(a.tracePolicy, a.startTime))
            });
            c("OneTraceCore").subscribe("trace-start", function(a) {
                (a.traceType === "INITIAL_LOAD" || a.traceType === "NAVIGATION") && (o != null && p("navigation", a.startTime), r = a, s(a.tracePolicy, a.startTime))
            });
            d("VisibilityState").subscribe(function(a, b) {
                if (b) p("VisibilityState", a);
                else {
                    b = (b = c("OneTraceCore").getLastNavigation()) == null ? void 0 : b.tracePolicy;
                    a = a;
                    s(b, a)
                }
            });
...
__d("one-trace", ["ImagePerfTracker", "OneTraceCore", "OneTraceSetup", "ScrollPerfTracker", "TypingPerfTracker"], (function(a, b, c, d, e, f, g) {
    "use strict";
...
__d("isObject", [], (function(a, b, c, d, e, f) {
    function a(a) {
        var b = typeof a;
