  ...
  function (a, b, c, d, e, f, g) {
    ...
    a = (function () {
      ...
      b.markerStart = function (a, b, c, e) {
        ...
        m &&
          (this.addMarker((h || (h = d("QPLEvent"))).getMarkerId(a), b, n),
      ...
      b.markerEnd = function (a, b, c, e) {
        ...
        var i = k(g, f);
        this.$4.forEach(function (d) {
          var g = { durationMs: f ? e - f.timestamp : 0, logData: i };
          d.onMarkerEnd && d.onMarkerEnd(b, a, c, e, g);
        });
        f.passesSampling &&
          (f.timestampIsApproximate !== !0 && this.$13(i),
          this.$6 === (h || (h = d("QPLEvent"))).getMarkerId(a) &&
            this.$1.onDebuggingIdEnded &&
            this.$1.onDebuggingIdEnded(),
          this.$16((h || (h = d("QPLEvent"))).getMarkerId(a), c));
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    ...
    function o(a) {
      ...
      if (
        c("gkx")("3752") &&
        typeof n.__sapienzMetadataCallback__ === "function"
      ) {
    ...
    function q(a, d) {
      return new (m || (m = b("Promise")))(function () {
        var b = d || a;
        typeof n.__je2e_recordQPLMarker === "function" &&
          n.__je2e_recordQPLMarker(b);
        (i || (i = c("Env"))).enable_qplinspector === !0 &&
    ...
    typeof n.__je2e_felabsTracePlugin_setQplInit === "function" &&
      n.__je2e_felabsTracePlugin_setQplInit((k || (k = c("performanceNow")))());
    var v = {
  ...
  function (a, b, c, d, e, f, g) {
    ...
    a = (function () {
      ...
      b.logPoint = function (a, b, d, e) {
        ...
        h.markerAnnotate(a, {
          string:
            ((j = {}), (j.join_id = d), (j.qpl_join__source = "client"), j),
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    ...
    a = function (a, b, d, e, f, g) {
      ...
      h = {
        string: { logger_id: d },
        int: { first_paint_time: h, response_start_time: m, cbt_delta: b },
      };
      m = {
