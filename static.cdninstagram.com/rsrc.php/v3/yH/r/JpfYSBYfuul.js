...
(function () {
  ...
  var b = (function (b) {
      b = b;
      var c = a(b);
      while (c) (b = c.ownerDocument), (c = a(b));
      return b;
    })(window.document),
    c = [],
    d = null,
  ...
  function f(a) {
    ...
    this.rootBounds = o(a.rootBounds);
    this.boundingClientRect = o(a.boundingClientRect);
    this.intersectionRect = o(a.intersectionRect || n());
  ...
  function g(a, b) {
    b = b || {};
    if (typeof a != "function") throw new Error("callback must be a function");
    if (b.root && b.root.nodeType != 1 && b.root.nodeType != 9)
  ...
  g.prototype.THROTTLE_TIMEOUT = 100;
  g.prototype.POLL_INTERVAL = null;
  g.prototype.USE_MUTATION_OBSERVER = !0;
  g._setupCrossOriginUpdater = function () {
    d ||
      (d = function (a, b) {
        !a || !b ? (e = n()) : (e = p(a, b)),
          c.forEach(function (a) {
  ...
  g.prototype.observe = function (a) {
    ...
    if (b) return;
    if (!(a && a.nodeType == 1)) throw new Error("target must be an Element");
  ...
  g.prototype._monitorIntersections = function (c) {
    var d = c.defaultView;
    if (!d) return;
    if (this._monitoringDocuments.indexOf(c) != -1) return;
    var e = this._checkForIntersections,
      f = null,
      g = null;
    this.POLL_INTERVAL
      ? (f = d.setInterval(e, this.POLL_INTERVAL))
      : (j(d, "resize", e, !0),
        j(c, "scroll", e, !0),
        this.USE_MUTATION_OBSERVER &&
          "MutationObserver" in d &&
          ((g = new d.MutationObserver(e)),
          g.observe(c, {
            attributes: !0,
            childList: !0,
            characterData: !0,
    ...
    this._monitoringDocuments.push(c);
    this._monitoringUnsubscribes.push(function () {
      var a = c.defaultView;
      a && (f && a.clearInterval(f), k(a, "resize", e, !0));
      k(c, "scroll", e, !0);
      g && g.disconnect();
    });
    d = (this.root && (this.root.ownerDocument || this.root)) || b;
    if (c != d) {
      d = a(c);
  ...
  g.prototype._unmonitorIntersections = function (c) {
    ...
    if (d == -1) return;
    var e = (this.root && (this.root.ownerDocument || this.root)) || b,
      f = this._observationTargets.some(function (b) {
        b = b.element.ownerDocument;
        if (b == c) return !0;
        while (b && b != e) {
          var d = a(b);
          b = d && d.ownerDocument;
    ...
    if (f) return;
    f = this._monitoringUnsubscribes[d];
    this._monitoringDocuments.splice(d, 1);
    this._monitoringUnsubscribes.splice(d, 1);
    f();
    if (c != e) {
      d = a(c);
  ...
  g.prototype._checkForIntersections = function () {
    if (!this.root && d && !e) return;
    var a = this._rootIsInDom(),
      b = a ? this._getRootRect() : n();
    this._observationTargets.forEach(function (c) {
      var e = c.element,
        g = m(e),
        i = this._rootContainsTarget(e),
        j = c.entry,
        k = a && i && this._computeTargetAndRootIntersection(e, g, b),
        l = null;
      !this._rootContainsTarget(e) ? (l = n()) : (!d || this.root) && (l = b);
      c = c.entry = new f({
        time: h(),
        target: e,
      ...
      !j
        ...
        : a && i
        ? this._hasCrossedThreshold(j, c) && this._queuedEntries.push(c)
        : j && j.isIntersecting && this._queuedEntries.push(c);
    }, this);
    this._queuedEntries.length && this._callback(this.takeRecords(), this);
  };
  g.prototype._computeTargetAndRootIntersection = function (a, c, f) {
    if (window.getComputedStyle(a).display == "none") return;
    c = c;
    a = r(a);
    var g = !1;
    while (!g && a) {
      var h = null,
        i = a.nodeType == 1 ? window.getComputedStyle(a) : {};
      if (i.display == "none") return null;
      if (a == this.root || a.nodeType == 9) {
        g = !0;
        if (a == this.root || a == b)
          d && !this.root
            ? !e || (e.width == 0 && e.height == 0)
              ? ((a = null), (h = null), (c = null))
              : (h = e)
            : (h = f);
        else {
          var j = r(a),
            k = j && m(j),
            n = j && this._computeTargetAndRootIntersection(j, k, f);
          k && n ? ((a = j), (h = p(k, n))) : ((a = null), (c = null));
        }
      } else {
        j = a.ownerDocument;
        a != j.body &&
  ...
  g.prototype._getRootRect = function () {
    var a;
    if (this.root && !s(this.root)) a = m(this.root);
    else {
      var c = s(this.root) ? this.root : b,
        d = c.documentElement;
      c = c.body;
      a = {
        top: 0,
        left: 0,
        right: d.clientWidth || c.clientWidth,
        width: d.clientWidth || c.clientWidth,
        bottom: d.clientHeight || c.clientHeight,
        height: d.clientHeight || c.clientHeight,
      };
    }
  ...
  g.prototype._rootIsInDom = function () {
    return !this.root || q(b, this.root);
  };
  g.prototype._rootContainsTarget = function (a) {
    var c = (this.root && (this.root.ownerDocument || this.root)) || b;
    return q(c, a) && (!this.root || c == a.ownerDocument);
  };
  g.prototype._registerInstance = function () {
    c.indexOf(this) < 0 && c.push(this);
  };
  ...
  function j(a, b, c, d) {
    typeof a.addEventListener == "function"
      ...
      : typeof a.attachEvent == "function" && a.attachEvent("on" + b, c);
  }
  function k(a, b, c, d) {
    typeof a.removeEventListener == "function"
      ? a.removeEventListener(b, c, d || !1)
      : typeof a.detachEvent == "function" && a.detachEvent("on" + b, c);
  }
  function l(a, b) {
  ...
  function r(c) {
    var d = c.parentNode;
    if (c.nodeType == 9 && c != b) return a(c);
    d && d.assignedSlot && (d = d.assignedSlot.parentNode);
    return d && d.nodeType == 11 && d.host ? d.host : d;
  }
  function s(a) {
    return a && a.nodeType === 9;
  }
  window.IntersectionObserver = g;
  window.IntersectionObserverEntry = f;
})();
(function () {
  function a() {
    ...
    if (c.dependencies != null)
      for (var d = c.depPosition; d < c.dependencies.length; d++) {
        ...
        e.tarjanGeneration != h
          ? (na(a, b, e), (c.tarjanLow = Math.min(c.tarjanLow, e.tarjanLow)))
          : e.tarjanOnStack &&
...
__d(
  ...
  function (a, b, c, d, e, f, g, h) {
    ...
    var p = [],
      ...
      G = new (c("BootloaderRetryTracker"))({
    ...
    function ba(a, b) {
      ...
      if (!w.has(c)) w.set(c, { type: "async", module: a, blocking: !!b });
      else {
        a = J(c);
        ...
        .then(function () {
          ...
          b > 0 &&
            c("FBLogger")("bootloader").info(
              ...
              a,
              f,
              (k || (k = c("performanceAbsoluteNow")))() - e,
              b
            );
      ...
      a.onload = h.bind(void 0, function () {
        ...
        a > 0 &&
          c("FBLogger")("bootloader").info(
            ...
            b,
            f,
            (k || (k = c("performanceAbsoluteNow")))() - g,
            a
          );
    ...
    function fa(a, b, e, f) {
      ...
      if (
        ...
        i.forEach(function (b, c) {
          b !== d("CSRIndexUtil").UNKNOWN_RESOURCE_INDEX && x.get(b) !== a
            ? l.add(c)
            : b > m && (m = b);
        });
    ...
    function U(a, b, e) {
      ...
      if (f)
        for (
          ...
          c("BootloaderConfig").lazySoT
            ? e
              ? (x.set(i, a), y.set(i, new Set()))
              : x.get(i) === d("ResourceHasher").PLACEHOLDER
              ? c("nullthrows")(y.get(i)).add(a)
              : x.has(i) ||
                (x.set(i, d("ResourceHasher").PLACEHOLDER),
                y.set(i, new Set([a])))
            : (!x.has(i) || e) && x.set(i, a);
            ...
            var l = JSON.stringify(
              a.map(function (b) {
                ...
                a.type === "js" || a.type === "css"
                  ...
                  : (c = a.src);
                return JSON.stringify(
                  babelHelpers["extends"]({ hash: b, rev: z.get(b) }, a, {
                    src: c,
                    tsrc: null,
                  })
                );
    ...
    function ja(a) {
      ...
      for (
        ...
        for (var k = 0; k < j.length; k++) {
          ...
          b.has(l)
            ? f++
            : m === d("ResourceHasher").PLACEHOLDER &&
              c("nullthrows")(y.get(l)).size === 1
            ? (f -= 1e6)
            : m === d("ResourceHasher").PLACEHOLDER && (f -= 1e3);
        }
        i.set(h, f);
      }
      ...
      for (
        ...
        for (e = 0; e < g.length; e++) {
          a = g[e];
          if (b.has(a)) x.set(a, f), b["delete"](a), y.set(a, new Set());
          else if (x.get(a) === d("ResourceHasher").PLACEHOLDER) {
    ...
    function X(a) {
      if (a.type === "csr")
        return d("CSRIndexUtil")
          .parseCSRIndexes(a.src)
          .filter(function (a) {
            return a !== d("CSRIndexUtil").UNKNOWN_RESOURCE_INDEX;
          });
      else if (a.p != null)
    ...
    var $ = {
      loadModules: function (a, b, f) {
        ...
        F.registerCallback(
          ...
          g
            .map(function (a) {
              if (c("BootloaderConfig").earlyRequireLazy) return da(a);
              else return F.tierOne(a);
            })
            .filter(Boolean)
        );
        M(function (b) {
      ...
      enableBootload: function (a, b) {
        for (var c in a)
          b && b.comp++,
            !u.has(c)
              ? (u.set(c, a[c]), n.has(c) && (n["delete"](c), I(c)))
              : b && b.dup_comp++;
        Z();
        o || ka();
      },
  ...
  function (a, b, c, d, e, f, g) {
    ...
    function a(a, b) {
      ...
      typeof window !== "undefined" &&
        ...
        Object.assign(f, c("getAsyncParamsFromCurrentPageURI")());
      (i || (i = c("Env"))).isCQuick &&
        !f.cquick &&
        ((f.cquick = (i || (i = c("Env"))).iframeKey),
      ...
      c("CurrentBusinessUser").business_id != null &&
        (f.__bid = c("CurrentBusinessUser").business_id);
      c("isSocialPlugin")() && (f.__sp = 1);
      if (c("SiteData").spin) {
        f[(e = c("StaticSiteData")).spin_rev_key] =
          c("SiteData")[e.spin_rev_key];
    ...
    b = (function () {
      function a(b) {
        ...
        this.config.extra_dom_content_event != null &&
          b.push(this.config.extra_dom_content_event);
...
__d(
  ...
  [],
  function (a, b, c, d, e, f) {
    a = { PROFILING_COUNTERS: 0, HEARTBEAT: 1, FLUX_PERF_TOOL: 2 };
    b = { PROFILING_COUNTERS: 0, HEARTBEAT: 1, FLUX_PERF_TOOL: 2 };
    f.beforeIDs = a;
    f.afterIDs = b;
  },
  66
    ...
    a = (function () {
      ...
      b.onNewContextCreated = function (a, b, c) {
        return this.isEnabled()
          ? this.onNewContextCreatedWhileEnabled(a, b, c)
          : null;
      };
      b.onBeforeContextStarted = function (a, b, c) {
        return this.isEnabled()
          ? this.onBeforeContextStartedWhileEnabled(a, b, c)
          : null;
      };
      ...
      b.expressInterest = function () {
        ...
        this.isEnabled() ||
          (this.onEnable(),
          c("TimeSlice").catchUpOnDemandExecutionContextObservers(this));
        this.$4 = !0;
        this.$5 = !0;
        return a;
      };
    ...
    c = (function (c) {
      ...
      e.onAfterContextEndedWhileEnabled = function (a, b, c, d) {
        ...
        a &&
          b != null &&
          c != null &&
          (this.$HeartbeatObserver5[d]
            ? (this.$HeartbeatObserver10(
                { type: "ignored_exec", timeMs: b },
                !0
              ),
              this.$HeartbeatObserver10(
                { type: "ignored_exec", timeMs: c },
                !1
              ))
            : (this.$HeartbeatObserver10({ type: "exec", timeMs: b }, !0),
              this.$HeartbeatObserver10({ type: "exec", timeMs: c }, !1)));
      };
      ...
      e.$HeartbeatObserver10 = function (a, c) {
        ...
        if (c) {
          ...
          if (this.$HeartbeatObserver3.type === "exec")
            a.type === "exec"
              ? this.$HeartbeatObserver14(
                  d,
                  e,
                  c ? "likely_btwn_exec" : "btwn_exec"
                )
              : this.$HeartbeatObserver13(a) &&
                this.$HeartbeatObserver14(
                  d,
                  e,
            ...
            if (a.type === "exec")
              this.$HeartbeatObserver14(
                d,
                e,
                c ? "likely_pre_exec" : "pre_exec"
              );
            else if (this.$HeartbeatObserver13(a) && c) {
              c =
                a.type === "beat"
                  ? "delayed_beat"
                  : "delayed_beat_btwn_ignored";
      ...
      e.$HeartbeatObserver14 = function (a, c, d) {
        a < c &&
          (j || (j = b("LogBuffer"))).write("time_slice_heartbeat", {
            begin: a,
            end: c,
      ...
      e.$HeartbeatObserver12 = function () {
        ...
        this.$HeartbeatObserver10({ type: "beat", timeMs: a }, !0);
      ...
      e.$HeartbeatObserver11 = function (a) {
        ...
        while (this.$HeartbeatObserver7.length > 0) {
          ...
          if (a - d > l.MAX_SINGLE_INTEREST_TIME_MS)
            c(), this.$HeartbeatObserver7.shift();
          else break;
        }
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    ...
    function c(a) {
      var b;
      l.getCallStack = (b = a.getCallStack) != null ? b : l.getCallStack;
      l.logger = a.logger;
    }
    function e() {
      return l.logger;
      ...
      if (!a) {
        a =
          (a = c == null ? void 0 : c.getCallStack) != null
            ? a
            : l.getCallStack;
        c = (c = c == null ? void 0 : c.logger) != null ? c : l.logger;
        a = a(2);
    ...
    function x(a) {
      a = Object.getOwnPropertyDescriptor(a, u);
      return a == null ? void 0 : a.value;
    }
    function y(a, b) {
      Object.defineProperty(a, u, { value: b });
      return b;
    }
    var z = {};
    function A(a) {
    ...
    function B(a, b) {
      if (A(a) && !aa(a)) {
        b = b;
        for (var c = 0; !b && c < w.length; ++c) b = w[c](a);
        b || (b = a[u]);
        if (b) {
          c = { virtualPropertyValues: {}, shadowPrototype: b, id: v++ };
          z.value = c;
          Object.defineProperty(a, t, z);
          b.interceptObject(a);
        }
      }
      return a;
    ...
    function ca(a, b, c) {
      ...
      a
        ...
        : m(!!a, "Could not get extension for the object");
      return c;
    }
    var D = "__ext",
      E = function () {},
      ...
      F = (function (b) {
        ...
        function a(a, c, d) {
          ...
          H(a.interceptor, babelHelpers.assertThisInitialized(a));
          a.implementation = c;
        ...
        c.updateDispatcherFunc = function () {
          ...
          m(!!c, "unhandled interceptor state " + b);
          this.dispatcherFunc = c(this);
        };
        c.onArgsMapperAdd = function (a) {
          this.onArgsMapper ||
            ((this.onArgsMapper = new da()), this.updateDispatcherFunc());
          return this.onArgsMapper.add(a);
        };
        c.onArgsMapperRemove = function (a) {
          var b;
          ((b = this.onArgsMapper) == null ? void 0 : b.remove(a)) &&
            this.updateDispatcherFunc();
          return a;
        };
        c.onArgsObserverAdd = function (a) {
          this.onArgsObserver ||
            ((this.onArgsObserver = new ea()), this.updateDispatcherFunc());
          return this.onArgsObserver.add(a);
        };
        c.onArgsObserverRemove = function (a) {
          var b;
          ((b = this.onArgsObserver) == null ? void 0 : b.remove(a)) &&
            this.updateDispatcherFunc();
          return a;
        };
        c.onValueMapperAdd = function (a) {
          this.onValueMapper ||
            ((this.onValueMapper = new fa()), this.updateDispatcherFunc());
          return this.onValueMapper.add(a);
        };
        c.onValueMapperRemove = function (a) {
          var b;
          ((b = this.onValueMapper) == null ? void 0 : b.remove(a)) &&
            this.updateDispatcherFunc();
          return a;
        };
        c.onValueObserverAdd = function (a) {
          this.onValueObserver ||
            ((this.onValueObserver = new ga()), this.updateDispatcherFunc());
          return this.onValueObserver.add(a);
        };
        c.onValueObserverRemove = function (a) {
          var b;
          ((b = this.onValueObserver) == null ? void 0 : b.remove(a)) &&
            this.updateDispatcherFunc();
          return a;
        };
        c.onArgsAndValueMapperAdd = function (a) {
          this.onArgsAndValueMapper ||
            ((this.onArgsAndValueMapper = new ha()),
            this.updateDispatcherFunc());
          return this.onArgsAndValueMapper.add(a);
        };
        c.onArgsAndValueMapperRemove = function (a) {
          var b;
          ((b = this.onArgsAndValueMapper) == null ? void 0 : b.remove(a)) &&
            (this.onArgsAndValueMapper.hasCallback() ||
    ...
    F.dispatcherCtors = (function () {
      ...
      a =
        ...
        (a[4] = function (a) {
          return function () {
            var b;
            a.onArgsObserver.call.apply(this, arguments) ||
              (b = a.implementation.apply(this, arguments));
            return b;
          };
        }),
        ...
        (a[8] = function (a) {
          return function () {
            var b,
              c = a.onArgsMapper.call.call(this, arguments);
        ...
        (a[12] = function (a) {
          return function () {
            var b,
              c = a.onArgsMapper.call.call(this, arguments);
            a.onArgsObserver.call.apply(this, c) ||
              (b = a.implementation.apply(this, c));
            return b;
          };
        }),
        ...
        (a[16] = function (a) {
          return function () {
            var b,
              c = a.onArgsAndValueMapper.call.call(this, arguments);
            b = a.implementation.apply(this, arguments);
            b = c.call(this, b);
            return b;
          };
    ...
    function I(a, b, c, d) {
      ...
      m(typeof a === "function", "cannot intercept non-function input");
      var e = G(a);
      e || (e = c ? new c(d, a, b) : new F(d, a, b));
      return e;
    }
    var J = (function (b) {
      babelHelpers.inheritsLoose(a, b);
    ...
    var P = (function () {
        function a(a, b) {
          this.onBeforInterceptObj = new (k || (k = d("hyperionHook"))).Hook();
          this.onAfterInterceptObj = new k.Hook();
      ...
      R = (function () {
        if (typeof __webpack_module_cache__ === "object")
          return new la(__webpack_module_cache__);
        else if (typeof b === "function")
          try {
            var a = b("__debug");
            if (typeof a === "object") return new ma(a);
          } catch (a) {}
        return new Q();
      })();
    function S(a, b, c, d) {
    ...
    var na = Object.freeze({
      __proto__: null,
      interceptModuleExports: S,
      validateModuleInterceptor: T,
    });
    h = (h = x(a)) != null ? h : new P(a, null);
    var U = L("setInterval", h),
      V = L("setTimeout", h);
    h = N("Promise", h);
    var oa = Object.freeze({
      ...
      W = Object.getPrototypeOf((j || (j = b("Promise"))).resolve());
    i = (i = x(W)) != null ? i : y(W, new P(W, null));
    W = h;
    h = L("then", i);
    var X = L("catch", i),
      pa = Object.freeze({
    ...
    g.assert = m;
    g.constructor = W;
    g.getFunctionInterceptor = G;
    g.getLogger = e;
    g.getObjectExtension = C;
    g.getOwnShadowPrototypeOf = x;
    g.getVirtualPropertyValue = ba;
    g.global = a;
    g.intercept = B;
    g.interceptAttribute = ra;
    g.interceptAttributeBase = $;
    g.interceptConstructor = ja;
    g.interceptConstructorMethod = N;
    g.interceptFunction = I;
    g.interceptMethod = L;
    g.interceptModuleExports = S;
    g.registerShadowPrototype = y;
    g.registerShadowPrototypeGetter = f;
    g.setAssertLoggerOptions = c;
    g.setInterval = U;
    g.setTimeout = V;
    g.setVirtualPropertyValue = ca;
    g.then = h;
    g.validateModuleInterceptor = T;
  },
  98
);
__d(
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    ...
    var h,
      ...
      j,
      k,
      l = d("FalcoUtils").getTaggedBitmap(33),
      m = 500 * 1024 * 0.6,
      n = "ods_web_batch",
      o = new Map(),
      p = new Set([
    ...
    function a(a, b) {
      ...
      for (
        ...
        if (o.has(i)) continue;
        g = (
          (g = (k || (k = c("AnalyticsCoreData"))).use_falco_as_mutex_key) !=
          null
            ? g
            : !1
        )
          ...
          : c("PersistedQueue").create(a, { onLoad: q, queueNameSuffix: h });
        o.set(i, g);
      }
      return c("nullthrows")(o.get(a + "^$" + b));
    }
    f = d("FalcoUtils").identityToString(
      (k || (k = c("AnalyticsCoreData"))).identity
    );
    ...
    function w(a, b) {
      (i || (i = d("ODS"))).bumpEntityKey(
        1344,
        "falco.fabric.www." + (k || (k = c("AnalyticsCoreData"))).push_phase,
        a,
        b
      );
    }
    function x(a, b, e, f) {
      ...
      (i || (i = d("ODS"))).bumpEntityKey(
        ...
        "falco.event." +
          a +
          "." +
          (k || (k = c("AnalyticsCoreData"))).push_phase,
        b,
        e
      );
      f && w(b, e);
    ...
    function z(a, b) {
      ...
      b = b.c;
      b != null &&
        (k || (k = c("AnalyticsCoreData"))).consents != null &&
        (d = d && A(b, (k || (k = c("AnalyticsCoreData"))).consents, a));
      return d;
    }
    function A(a, b, d) {
      var e = y[a];
    ...
    function D(a, b, d, e, f, g) {
      if (
        (k || (k = c("AnalyticsCoreData"))).enable_cmcd_observer &&
        !p.has(a)
      ) {
        a = babelHelpers["extends"](
          { name: a, time: b, sampled: d, getData: f, policy: e },
...
__d(
  "SidebarPrelude",
  ["Arbiter", "Bootloader", "CSS", "ChatConfig", "URI", "setTimeout"],
  function (a, b, c, d, e, f, g) {
    var h,
      i = d("ChatConfig").get("sidebar.hide_buddylist_off_homepage"),
    ...
    function a(a) {
      ...
      if (b) {
        ...
        b.clientWidth > a &&
          (d("CSS").addClass(b, l),
          c("Arbiter").inform("sidebar/visibility", !0, "state"));
      }
    }
    function b() {
